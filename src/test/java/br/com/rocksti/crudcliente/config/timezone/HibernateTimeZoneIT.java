package br.com.rocksti.crudcliente.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import br.com.rocksti.crudcliente.IntegrationTest;
import br.com.rocksti.crudcliente.repository.timezone.DateTimeWrapper;
import br.com.rocksti.crudcliente.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM cc_date_time_wrapper where id=%d", fieldName, id);
    }
